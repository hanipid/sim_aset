  ...
  <div class="panel-body">
    ...
    <div>
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation"><a href="{{ url('kode_barang/subKelompok') }}" class="btn">Sub Kelompok</a></li>
        <li role="presentation" class="active"><a href="#" class="btn" aria-controls="sub-sub-kelompok" role="tab" data-toggle="tab">Sub Sub Kelompok</a></li>
      </ul>
        ...
        <div role="tabpanel" class="tab-pane active" id="kelompok">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-xs-10">
                  <a href="#" class="btn btn-block btn-primary">Kampung</a>
                </div>
                <div class="col-xs-2">
            ...
            <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-xs-10">
                  <a href="#" class="btn btn-block btn-primary">Lain - lain</a>
                </div>
                <div class="col-xs-2">
