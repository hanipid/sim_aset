  ...
  <div class="panel-body">
    ...
    <div>
      ...
      <ul class="nav nav-tabs" role="tablist">
        ...
        <li role="presentation" class="active"><a href="#unitBidang" class="btn" aria-controls="unitBidang" role="tab" data-toggle="tab">Unit Bidang</a></li>
              ...
              <table class="table table-condensed">
                ...
                <tbody>
                  <tr onclick="pindah()">
                    ...
                    <td>
                      <a href="{{ url('master_wilayah_lokasi/editUnitBidang') }}" class="btn btn-primary btn-sm">Edit</a>
                    </td>
                  </tr>
                  <tr>
                    <td>02</td>
    ...
    <div class="modal-content">
      <form class="form-horizontal">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Input Unit Bidang</h4>
        </div>
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="nama_unit_bidang" placeholder="Nama Unit Bidang">
            </div>
          </div>
        </div>
...
<script>
  function pindah() {
    document.location.href = "{{ url('master_wilayah_lokasi/subUnit') }}";
  }
</script>